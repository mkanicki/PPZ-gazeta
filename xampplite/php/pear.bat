...
FOR %%x IN ("\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\Users\Ola\Desktop\xampplite\xampplite-zf\xampplite\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\Users\Ola\Desktop\xampplite\xampplite-zf\xampplite\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\Users\Ola\Desktop\xampplite\xampplite-zf\xampplite\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\Users\Ola\Desktop\xampplite\xampplite-zf\xampplite\php\.\php.exe"
GOTO :INSTALLED
