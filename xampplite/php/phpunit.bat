...
if "%PHPBIN%" == "" set PHPBIN=\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\xampplite-zf\xampplite\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\xampplite-zf\xampplite\php\phpunit" %*
