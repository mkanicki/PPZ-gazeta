...
GOTO doshift
:noshift
\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\Users\Ola\Desktop\xampplite\xampplite-zf\xampplite\php\.\php.exe -q -d output_buffering=1 -d include_path="\xampp\php\pear" \xampp\php/Text/Highlighter/generate.bat %MHL_PARAMS%
