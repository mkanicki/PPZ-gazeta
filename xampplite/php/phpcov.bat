...
set PHPBIN="\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\xampplite-zf\xampplite\php\.\php.exe"
"\Users\Ola\Desktop\OLA\WSISIZ\6. semestr\Internetowe bazy danych 2\xampplite-zf\xampplite\php\.\php.exe" "\xampp\php\phpcov" %*
